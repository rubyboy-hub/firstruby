...
class FriendlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendlist" do
    assert_difference('Friendlist.count') do
      post friendlists_url, params: { friendlist: { email: @friendlist.email, first_name: @friendlist.first_name, gender: @friendlist.gender, last_name: @friendlist.last_name, phone: @friendlist.phone } }
    end
  ...
  test "should update friendlist" do
    patch friendlist_url(@friendlist), params: { friendlist: { email: @friendlist.email, first_name: @friendlist.first_name, gender: @friendlist.gender, last_name: @friendlist.last_name, phone: @friendlist.phone } }
